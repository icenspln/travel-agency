      ...
      <main className="main flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        >
          ...
          <div className="flex gap-3 md:gap-8 items-center justify-start my-10">
            <a href="">
              <button className="py-3 px-4  md:py-4 md:px-7 bg-yellow text-white rounded-md md:rounded-xl md:text-lg font-medium transition duration-300 hover:bg-orange">
                Find out more
              </button>
            </a>
